...
{
    public static class ValidationExtesion
    {
        //public  async Task<ModelStateDictionary> Validation<T>(this T obj,string filedname, ModelStateDictionary modelState,Func<bool> fn)
        //{
            ...
            //// a display name.
            //MemberInfo? property =obj?.GetType().GetProperty(filedname);
