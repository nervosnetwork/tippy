...
namespace Ckb.Molecule.Tests.Base
{
    ...
    public class StructSerializerTests
    {
        ...
        public void TestOnlyAByte()
        {
            ...
            var onlyAByteSerializer = new StructSerializer<OnlyAByte>(obj, new List<BaseSerializer>(new BaseSerializer[] { new ByteSerializer(obj.F1) }));
        ...
        public void TestByteAndUInt32()
        {
            ...
            var byteAndUInt32Serializer = new StructSerializer<ByteAndUInt32>(obj, new List<BaseSerializer>(new BaseSerializer[] { new ByteSerializer(obj.F1), new UInt32Serializer(obj.F2) }));
